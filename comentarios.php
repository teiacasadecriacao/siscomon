...
<?php
$query="SELECT count(id_postagem) as count, id_postagem FROM comentarios WHERE `id_pauta`='$_GET[id]' GROUP BY id_postagem ORDER BY count(id_postagem) DESC LIMIT 1;";
    ...
    <div class="wrapper">
        <div class = "pauta-atual">
            <div class="pauta-atual-conteudo">
                <a href="ver-pauta?id=<?php echo $_GET[id];?>"><h2>Postagem:</h2></a>
